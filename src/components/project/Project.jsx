  ...
  return (
        <div className="w-full flex flex-col space-y-10">
          <div className=" flex flex-col">
            <h1 className=" text-3xl font-montserrat font-medium text-gray-800"> MY PROJECT</h1>
            <p className=" text-gray-700"> Quilityful user experience website </p>
          </div>
          <div className="w-full border text-gray-700 p-2 space-y-3">
            <h3 className=" text-lg font-montserrat font-semibold"> Project Title-1--------- </h3>
