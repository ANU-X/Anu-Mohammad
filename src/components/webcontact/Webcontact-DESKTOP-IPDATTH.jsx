...
const Webcontacts = () => {
  return (
    <div className=" container w-5xl mx-auto">
      <div className="flex justify-between text-[#3bd595] items-center px-2 h-[12vh] text-4xl">
      ...
      {/* --------------contact side------------------ */}
      <div className="container w-5xl mx-auto flex items-center justify-center gap-8 h-[76vh]">
        <div className=" flex flex-col gap-5 text-gray-200 items-center">
          <MdCall className="text-4xl text-sky-600" />
          <h1>++880 170060-6955</h1>
        </div>
        <div className=" flex flex-col gap-5 text-gray-200 items-center px-8">
          <BiLogoGmail className="text-4xl text-sky-600" />
          <h1> mdanumia1999@gmail.com </h1>
        </div>
        <div className=" flex flex-col gap-5 text-gray-200 items-center px-8">
          <MdLocationOn className="text-4xl text-sky-600" />
